...
**Complete demo roster:** Caesar, Atbash, ROT13, Scytale, Polybius, Monoalphabetic, Homophonic, Playfair, Four-Square, Two-Square, Hill, Straddling Checkerboard, Vigenère, Beaufort, Porta, Gronsfeld, Running Key, Chaocipher, Rail Fence, Columnar, Double Transposition, Bifid, Trifid, Fractionated Morse, Nihilist, ADFGX, ADFGVX, Bazeries, Great Cipher, VIC, Stager, Confederate Vigenère, Dictionary Code, Alberti Disk, Jefferson Disk, Enigma, Lorenz, M-209, Vernam, Navajo Code Talkers, Pigpen, Bacon, Tap Code, Babington, Copiale, Beale, Voynich, Kryptos, Zodiac, One-Time Pad, Solitaire.
