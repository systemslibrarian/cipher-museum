...
- **Cipher Corpus v0.1** ([cipher-corpus.html](https://ciphermuseum.com/cipher-corpus.html)): Launched the first known-answer benchmark library for classical ciphers. Includes a browser UI, downloadable JSON/CSV datasets, Challenge Mode for learners, Known Mode for tool builders, and full accessibility compliance. Integrated site-wide in nav and footer. All tests passing.
